...
export default function SourceAdmin() {
  ...
  return <main><header><div className="brand-lockup"><span>AI Procurement Agent</span><img src="/mccia-logo.png" alt="MCCIA" /></div><p className="eyebrow">SOURCE OPERATIONS</p><h1>Approve before you acquire.</h1><p>Register a supplier source with auditable rights evidence and a bounded operating policy.</p></header>
